                ...
                <div>
                  <div className="flex flex-col gap-2">
                    <div className="flex gap-2">
                      <h1 className="text-2xl font-bold text-slate-400 md:text-3xl dark:text-slate-600">
                        Hola,
                      </h1>
                      <span className="text-2xl font-bold text-slate-600 normal-case md:text-3xl dark:text-slate-600">
