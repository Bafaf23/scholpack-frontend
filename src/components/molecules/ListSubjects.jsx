...
export default function ListSubjects({ dataSubjects, onSubjectDeleted }) {
  if (!dataSubjects || dataSubjects?.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-zinc-200 bg-slate-50/50 p-12 text-center dark:border-zinc-800 dark:bg-zinc-900/50">
